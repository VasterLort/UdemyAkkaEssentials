...
object TimersSchedulers extends App {
  ...
  val simplerActor = system.actorOf(Props[SimpleActor])
   ...
   *
   * - if the actor receives a message (anything), you have to send it another message
